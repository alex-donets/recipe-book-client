...
const TermsAndConditions = () => {
    return (
        <div>
            ...
            <p>Welcome to Recipe Book!</p>

            <p className="terms-text">
                These terms and conditions outline the rules and regulations for the use of Recipe-Book&apos;s Website,
                located at https://github.com/veronika-donets/recipe-book.
            </p>

            <p>
                By accessing this website we assume you accept these terms and conditions. Do not continue to use Recipe
                Book if you do not agree to take all of the terms and conditions stated on this page. Our Terms and
            ...
            <p>
                We employ the use of cookies. By accessing Recipe Book, you agreed to use cookies in agreement with the
                https://github.com/veronika-donets/recipe-book&apos;s Privacy Policy.
            </p>
            ...
            <p>
                Unless otherwise stated, https://github.com/veronika-donets/recipe-book and/or its licensors own the
                intellectual property rights for all material on Recipe Book. All intellectual property rights are
                reserved. You may access this from Recipe Book for your own personal use subjected to restrictions set
                in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Recipe Book</li>
                <li>Sell, rent or sub-license material from Recipe Book</li>
                <li>Reproduce, duplicate or copy material from Recipe Book</li>
                <li>Redistribute content from Recipe Book</li>
            </ul>
            ...
            <p>
                ...
                certain areas of the website. https://github.com/veronika-donets/recipe-book does not filter, edit,
                publish or review Comments prior to their presence on the website. Comments do not reflect the views and
                opinions of https://github.com/veronika-donets/recipe-book,its agents and/or affiliates. Comments
                reflect the views and opinions of the person who post their views and opinions. To the extent permitted
                by applicable laws, https://github.com/veronika-donets/recipe-book shall not be liable for the Comments
                or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or
                posting of and/or appearance of the Comments on this website.
            </p>

            <p>
                https://github.com/veronika-donets/recipe-book reserves the right to monitor all Comments and to remove
            ...
            <p>
                You hereby grant https://github.com/veronika-donets/recipe-book a non-exclusive license to use,
            ...
            <p>
                ...
                absence of https://github.com/veronika-donets/recipe-book; and (d) the link is in the context of general
            ...
            <p>
                ...
                website, you must inform us by sending an e-mail to https://github.com/veronika-donets/recipe-book.
                Please include your name, your organization name, contact information as well as the URL of your site, a
                list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to
            ...
            <p>
                No use of https://github.com/veronika-donets/recipe-book&apos;s logo or other artwork will be allowed
